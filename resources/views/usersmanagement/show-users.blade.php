...
@section('content')
    <div class="section-banner">
        <!-- SECTION BANNER ICON -->
        <img class="section-banner-icon" src="{{ asset('dashboard/img/banner/members-icon.png') }}" alt="members-icon">
        <!-- /SECTION BANNER ICON -->

        <!-- SECTION BANNER TITLE -->
        <p class="section-banner-title">Members ({{ \App\Models\User::all()->count() }})</p>
        <!-- /SECTION BANNER TITLE -->
    ...
    <div class="py-3">
        <div class="section-header-info">
            ...
            <!-- SECTION TITLE -->
            <h2 class="section-title">Showing All Users <span
                    class="highlighted">{{ \App\Models\User::all()->count() }}</span></h2>
            <!-- /SECTION TITLE -->
        </div>
        <div class="grid">
                ...
                <div class="user-preview landscape">
                    ...
                    <div class="user-preview-info" id="users_table">
                        ...
                        <div class="user-preview-actions">
                            ...
                            <button class="button danger" data-target="#confirmDelete"
                                data-messages="Are you sure you want to delete this user ?">
                                <a href="{{ URL::to('users/' . $user->id) }}" data-toggle="tooltip"
                                    title="'Delete'))   ">
