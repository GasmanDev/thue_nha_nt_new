...
<head>
    ...
    <title>Selio - downloaded from themelock.com - Real Estate HTML Template</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

    <link rel="shortcut icon" href="{{ asset('real-estate/images/favicon.png') }}">
    <link rel="stylesheet" href="{{ asset('real-estate/css/animate.min.css') }}">
    <link rel="stylesheet" href="{{ asset('real-estate/css/style.css') }}">
    <link rel="stylesheet" href="{{ asset('real-estate/css/responsive.css') }}">
    <link rel="stylesheet" href="{{ asset('real-estate/css/color.css') }}">
</head>
...
<body>
    <div class="wrapper">
                        ...
                        <div class="col-xl-3 col-md-5 col-sm-12">
                            <div class="header-social">
                                ...
                                @if (Route::has('login'))
                                    ...
                                    @else
                                        <a href="{{ route('login') }}">
                                            <span> {{ trans('auth.loginOrRegister') }}</span>
                                        </a>
                                    @endif
                                    @endif
                                </div>
                            ...
                            <div class="col-xl-12">
                                <nav class="navbar navbar-expand-lg navbar-light">
                                    <a class="navbar-brand" href="#">
                                        <img src="{{ asset('real-estate//images/logo.png') }}" alt="logo">
                                    </a>
                                    ...
                                    <div class="navbar-collapse" id="navbarSupportedContent">
                                        <ul class="navbar-nav mr-auto">
                                            ...
                                            <li class="nav-item dropdown">
                                                ...
                                                <div class="dropdown-menu animated">
                                                    <a class="dropdown-item"
                                                        href="17_Features_Example_Alt_Titlebar.html">Features Example</a>
                                            ...
                                            <li class="nav-item dropdown">
                                                ...
                                                <div class="dropdown-menu animated">
                                                    <a class="dropdown-item" href="21_List_Layout_With_Map.html">List Layout
                                                        with Map</a>
                                                    <a class="dropdown-item" href="22_List_Layout_With_Sidebar.html">List
                                                        Layout with Sidebar</a>
                                                    <a class="dropdown-item" href="11_Agent_Profile.html">Agent Profile</a>
                                                    <a class="dropdown-item" href="24_Property_Single.html">Property
                                                        Single</a>
                                                </div>
                                            </li>
                                            <li class="nav-item dropdown">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <form action="#" class="row banner-search">
                                ...
                                <div
                                    class="d-flex flex-row drop-text align-items-center space-between justify-content-center px-4 my-2 border-left">
                                    <span>Thêm</span>
                                    <i class="fa fa-angle-double-down pl-4"></i>
                                </div>
                                ...
                                <div class="drop-menu-input w-100 ">
                                    <div class="form_field tpmax ">
                                        <div class="form-group">
                                            <div class="drop-menu border-left-0">
                                                <div class="select">
                                                    <span>Max Price</span>
                                                    <i class="fa fa-angle-down"></i>
                                                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-sm-6 col-md-4">
                            <div class="bottom-logo">
                                <img src="{{ asset('real-estate//images/logo.png') }}" alt="logo" class="img-fluid">
                            </div>
                        </div>
        ...
        <!--wrapper end-->
        <script src="{{ asset('real-estate/js/jquery-3.3.1.min.js') }}"></script>
        <script src="{{ asset('real-estate/js/modernizr-3.6.0.min.js') }}"></script>
        <script src="{{ asset('real-estate/js/bootstrap.min.js') }}"></script>
        <script src="{{ asset('real-estate/js/scripts.js') }}"></script>
        <script src="{{ asset('real-estate/js/map-cluster/infobox.min.js') }}"></script>
        <script src="{{ asset('real-estate/js/map-cluster/markerclusterer.js') }}"></script>
